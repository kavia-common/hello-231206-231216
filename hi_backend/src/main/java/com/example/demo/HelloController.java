...
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for hibackend")
public class HelloController {
    
    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to hibackend";
    }
    ...
    public String info() {
        return "Spring Boot Application: hibackend";
    }
} 